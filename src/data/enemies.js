...
export const ENEMY_TYPES = {
  ...
  SQUARESPACE: { name: 'Squarespace', label: 'Sqsp',   hp: 1, speed: 75,  points: 10, radius: 16, color: '#2d2d2d', behavior: 'chase', shape: 'roundRect' },
  ...
  BUBBLE:      { name: 'Bubble',      label: 'Bbbl',   hp: 1, speed: 75,  points: 10, radius: 16, color: '#1a3a1a', behavior: 'chase', shape: 'roundRect' },
  ...
  CURSOR:      { name: 'Cursor',      label: 'Crsr',   hp: 3, speed: 155, points: 50, radius: 22, color: '#1a1a3e', behavior: 'dash', shape: 'octagon' },
  ...
  V0:          { name: 'v0',          label: 'v0',     hp: 3, speed: 160, points: 50, radius: 20, color: '#1a1a1a', behavior: 'dash', shape: 'octagon' },
